...
def verify_release(path: str | Path, *, launch: bool = False) -> tuple[str, ...]:
    ...
    v12_guide = release / "Documentation" / "v1.2-record-replay-reliability.md"
    required = (release, internal, executable, dll, dbc, multi_bms_guide, v12_guide)
